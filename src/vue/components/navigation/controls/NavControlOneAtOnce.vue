...
const _getResetScrollBehavior = () => {
    return isDesktopLayout.value ? "instant" : "smooth"
}

const _resetScroll = () => {
    window.scrollTo({top: 0, behavior: _getResetScrollBehavior()})
}
...
const _resetScrollForMobile = () => {
    ...
    window.scrollTo({
        ...
        behavior: _getResetScrollBehavior()
    })
}
